...
MPS_BEGIN_DECLS
    ...
    * or the element is detached.
    */
    mps_list_element* previous_element;
};
...
struct mps_list {
    ...
    */
    mps_list_element* first_element;

    /**
    * @brief A pointer to the last element of the list.
    */
    mps_list_element* last_element;
...
void mps_list_element_free(mps_list_element* list_element);
mps_list_element* mps_list_element_next(mps_list_element* list_element);
mps_list_element* mps_list_element_previous(mps_list_element* list_element);
void* mps_list_element_value(mps_list_element* list_element);

mps_list* mps_list_new(void);
void mps_list_free(mps_list* list);
int mps_list_size(mps_list* list);
void mps_list_append(mps_list* list, mps_list_element* list_element);
mps_list_element* mps_list_first(mps_list* list);
mps_list_element* mps_list_last_element(mps_list* list);
