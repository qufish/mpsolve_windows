...
mps_formal_monomial* mps_formal_monomial_new_with_string(const char* coeff_string, long);

mps_formal_monomial* mps_formal_monomial_new_with_strings(const char* real, const char* imag,
    long degree);

void mps_formal_monomial_free(mps_formal_monomial* m);

void mps_formal_monomial_print(mps_formal_monomial* m);
...
char* mps_formal_monomial_get_str(mps_formal_monomial* m);
...
#include <gmpxx.h>
    ...
    namespace formal {
        ...
        public:
            ...
            */
            friend char* get_string(const mps::formal::Monomial& m);
