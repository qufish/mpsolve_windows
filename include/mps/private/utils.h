...
#include <mps/mps.h>
    ...
    /* This function is currently implemented in parser.cpp for historical reasons. */
...
/* functions in newton.cpp */
int mps_intlog2(int n);

/* functions in strndup.cpp */

char* mps_strdup(const char* source);
