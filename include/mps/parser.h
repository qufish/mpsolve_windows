...
MPS_BEGIN_DECLS
	...
	mps_polynomial* mps_parse_stream(mps_context* ctx, FILE* input_stream);
mps_polynomial* mps_parse_file(mps_context* ctx, const char* path);
mps_polynomial* mps_parse_string(mps_context* ctx, const char* c_string);
