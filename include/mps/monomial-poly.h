...
struct mps_monomial_poly {
    ...
    */
    ...
    mps_monomial_poly_double_buffer db;
    ...
    * of the polynomial.
    */
    mps_mutex_t regenerating_mutex;
...
mps_monomial_poly* mps_monomial_poly_new(mps_context* ctx, long int degree);

void mps_monomial_poly_free(mps_context* ctx, mps_polynomial* mp);

long int mps_monomial_poly_get_precision(mps_context* ctx, mps_monomial_poly* mp);

long int mps_monomial_poly_raise_precision(mps_context* ctx, mps_polynomial* mp, long int prec);

void mps_monomial_poly_set_coefficient_q(mps_context* ctx, mps_monomial_poly* mp, long int i,
    mpq_t real_part, mpq_t imag_part);
void mps_monomial_poly_set_coefficient_d(mps_context* ctx, mps_monomial_poly* mp, long int i,
    double real_part, double imag_part);
void mps_monomial_poly_set_coefficient_f(mps_context* ctx, mps_monomial_poly* p, long int i,
    mpc_t coeff);
void mps_monomial_poly_set_coefficient_int(mps_context* ctx, mps_monomial_poly* mp, long int i,
    long long real_part, long long imag_part);

void mps_monomial_poly_set_coefficient_s(mps_context* ctx, mps_monomial_poly* mp,
    int i, const char* real_coeff,
    const char* imag_coeff);

void mps_monomial_poly_get_coefficient_d(mps_context* ctx, mps_monomial_poly* p,
    int i, cplx_t output);

void mps_monomial_poly_get_coefficient_q(mps_context* ctx, mps_monomial_poly* p,
    int i, mpq_t real_output, mpq_t imag_output);

mps_monomial_poly* mps_monomial_poly_derive(mps_context* ctx, mps_monomial_poly* p, int k, long int wp);

mps_boolean mps_monomial_poly_feval(mps_context* ctx, mps_polynomial* p, cplx_t x, 
    cplx_t value, double* error);
...
mps_monomial_poly* mps_monomial_poly_read_from_stream(mps_context* ctx, mps_input_buffer* buffer,
