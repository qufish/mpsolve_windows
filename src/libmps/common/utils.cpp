        ...
        const char* input)
{
    ...
    *(end + 1) = '\0';
    start = (char*)mps_realloc(start, (int)(end - start) + 2);
        ...
        const char* input)
{
    ...
    if (sign == -1)
    {
        ...
        else
        {
            ...
            equivalent_rational_string = (char*)mps_realloc
            (equivalent_rational_string,
                (int)length + 2);
    ...
    if (exponent > 0)
    {
        size_t length = strlen(equivalent_rational_string);
        equivalent_rational_string = (char*)mps_realloc
        (equivalent_rational_string, (int)(length + exponent) + 1);
    ...
    else if (exponent < 0)
    {
        ...
        equivalent_rational_string = (char*)mps_realloc
        (equivalent_rational_string, (int)length);
