...
*/
mps_boolean
    mps_secular_feval(mps_context* ctx, mps_polynomial* p, cplx_t x, cplx_t value)
{
...
mps_boolean
    mps_secular_feval_derivative(mps_context* ctx, mps_polynomial* p, cplx_t x, cplx_t value)
{
    mps_secular_equation* sec = MPS_SECULAR_EQUATION(p);
    cplx_t ctmp;
    int i;
...
*/
mps_boolean
    mps_secular_feval_with_error(mps_context* ctx, mps_polynomial* p, cplx_t x, cplx_t value,
        double* error)
{
    mps_secular_equation* sec = MPS_SECULAR_EQUATION(p);
    cplx_t ctmp;
...
*/
mps_boolean
    mps_secular_deval(mps_context* ctx, mps_polynomial* p, cdpe_t x, cdpe_t value)
{
    mps_secular_equation* sec = MPS_SECULAR_EQUATION(p);
    cdpe_t ctmp;
    int i;
...
mps_boolean
    mps_secular_deval_derivative(mps_context* ctx, mps_polynomial* p, cdpe_t x, cdpe_t value)
{
    mps_secular_equation* sec = MPS_SECULAR_EQUATION(p);
    cdpe_t ctmp;
    int i;
...
*/
mps_boolean
    mps_secular_deval_with_error(mps_context* ctx, mps_polynomial* p,
...
*/
mps_boolean
    mps_secular_meval(mps_context* ctx, mps_polynomial* p, mpc_t x, mpc_t value)
{
    mps_secular_equation* sec = MPS_SECULAR_EQUATION(p);
    ...
    * in the input polynomial. */
    if (p->prec > 0 && p->prec < (long int)wp)
        wp = p->prec;
...
*/
mps_boolean
    mps_secular_meval_with_error(mps_context* ctx, mps_polynomial* p, mpc_t x, mpc_t value, rdpe_t error)
{
    mps_secular_equation* sec = MPS_SECULAR_EQUATION(p);
    mpc_t ctmp;
    rdpe_t rtmp, ax;
