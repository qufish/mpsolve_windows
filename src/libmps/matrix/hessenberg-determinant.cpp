...
{
    cplx_t* vec = (cplx_t*)mps_newv(cplx_t, (int)n);
    size_t local_n = n;
    int i, j;
    *acc_exponent = 0;
...
{
    cdpe_t* vec = mps_newv(cdpe_t, (int)n);
    size_t local_n = n;
    int i;
...
{
    mpc_t* matrix = mps_newv(mpc_t, (int)(n * n));
    size_t local_n = n;
    ...
    rdpe_t* verrors = mps_newv(rdpe_t, (int)n);
